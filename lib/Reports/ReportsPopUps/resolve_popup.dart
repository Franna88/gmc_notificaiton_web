...
class ResolvePopup extends StatefulWidget {
  const ResolvePopup({super.key});

  @override
  State<ResolvePopup> createState() => _ResolvePopupState();
}

class _ResolvePopupState extends State<ResolvePopup> {
